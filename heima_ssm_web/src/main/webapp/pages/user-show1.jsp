            ...
            <div class="box-body">
                ...
                <div class="tab-pane" id="tab-treetable">
                    <table id="collapse-table" class="table table-bordered table-hover dataTable">
                        ...
                        <tbody>
                            <c:forEach items="${user.roles}" var="role" varStatus="now">
                                <tr data-tt-id="${now.index + 1}" data-tt-parent-id="0">
                                    <td>${role.roleName}</td>
                                    <td>${role.roleDesc}</td>
                                </tr>
                                    <c:forEach items="${role.permissions}" var="permission" varStatus="second">
                                        <tr data-tt-id="${now.index + 1}-${second.index + 1}"  data-tt-parent-id="${now.index + 1}">
