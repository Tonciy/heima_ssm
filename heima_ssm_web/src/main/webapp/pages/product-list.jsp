    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=1&size=4">产品管理</a></li>
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="t">
                                <li><a href="${pageContext.request.contextPath}/product/findAll.do?page=${t}&size=${pageInfo.pageSize}">${t}</a></li>
                            </c:forEach>
